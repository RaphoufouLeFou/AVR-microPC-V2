...
avr-gcc -O3 -Wl,--gc-sections,--section-start=.FAR_MEM1=0x10000,--section-start=.FAR_MEM2=0x20000,--section-start=.FAR_MEM3=0x30000 -mmcu=atmega128a -w -flto -g RayTracing.o BaseLib/driver.o out.o BaseLib/lib.o BaseLib/OS.o BaseLib/FileSystem.o BaseLib/memory.o -o image.elf
