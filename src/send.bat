...
avr-g++ -c -O3 -w -mmcu=ATmega128a -DF_CPU=16000000L BaseLib/FileSystem.cpp -o BaseLib/FileSystem.o
avr-g++ -c -O3 -w -mmcu=ATmega128a -DF_CPU=16000000L BaseLib/memory.cpp -o BaseLib/memory.o
avr-g++ -c -O3 -w -mmcu=ATmega128a -DF_CPU=16000000L BaseLib/list.cpp -o BaseLib/list.o
